...
const App = () => {
   ...
   return (
      <div className="p-6 max-w-4xl mx-auto">
         <a href="/">
            <h1 className="text-6xl font-extrabold text-center text-purple-600 mb-1">EventSpot</h1>
            <h2 className="text-3xl font-semibold text-center text-gray-700">Lite</h2>
         </a>
